...
The full data set of OpenCelliD was downloaded as of 14 April 2018. The downloaded .csv file is 3.1 GB on disk. The following attributes of OpenCelliD data set are used for the analysis \cite{opencellid}:
\begin{itemize}
...
\begin{enumerate}
   \item Import .csv files to pySpark DataFrame
    ...
    \begin{itemize}
        ...
        \item Convert unix timestamp to CET datetime
    \end{itemize}
